...
#pragma region CollisionFunctionality
	...
	bool IsOverlapping(const std::vector<Point2f>& vertices1, const std::vector<Point2f>& vertices2);
	bool IsOverlapping(const std::vector<Point2f>& polygon, const Rectf& rectangle);
...
#pragma region GeneralFunctionality
	...
	Point2f GetRectCentreBottom(const Rectf& rect);
