...
//Index2i utils::Get2DIndexFromLinear(int linearIndex, int nrOfColumns)
//{
//	int column{ linearIndex % nrOfColumns };
//	int row{ linearIndex / nrOfColumns };
//	return Index2i{ column, row };
//}
